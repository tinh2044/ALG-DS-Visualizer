...
import { generateRandomTree } from '@/redux/bstSlice';
import { RootState } from '@/redux/store';

const BSTRandomGenerator: React.FC = () => {
  const dispatch = useDispatch();
  const { isAnimating } = useSelector((state: RootState) => state.bst);
...
export default BSTRandomGenerator; 